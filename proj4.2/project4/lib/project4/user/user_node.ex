defmodule Project4.UserNode do
    ...
    def add_block(pid, logger_pid) do
        GenServer.cast(pid, {:add_block, logger_pid})
    end
    ...
    def handle_cast({:add_block, logger_pid}, {pid, public_address, ledger_pid}) do
        Project4.BitcoinSimulator.add_log(logger_pid, "Block mining started by " <> public_address <> ".")
        
        # get ledger data
        {blockchain, outputs, transactions, unverified_transactions} =
            Project4.GlobalLedger.get_ledger_data(ledger_pid, true)
        
        if length(unverified_transactions) > 0 do
            ...
            Project4.BitcoinSimulator.add_log(logger_pid, "Block mined by " <> public_address <> ".")
